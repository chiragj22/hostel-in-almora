...
function displayInfo(event) {
    ...
    if (height === '0em' ) {
        ...
        if (closeElement) {
          closeElement.parentElement.getElementsByClassName('open')[0].style.display = 'block';
          closeElement.parentElement.getElementsByClassName('close')[0].style.display = 'none';
